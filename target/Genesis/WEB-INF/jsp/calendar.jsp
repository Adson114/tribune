...
<div id="Demo">
    <div id="CalendarMain">
        ...
        <div id="context">
            <div class="week">
                <h3 style="padding-top: 5px"> 一 </h3>
                <h3 style="padding-top: 5px"> 二 </h3>
                <h3 style="padding-top: 5px"> 三 </h3>
                <h3 style="padding-top: 5px"> 四 </h3>
                <h3 style="padding-top: 5px"> 五 </h3>
                <h3 style="padding-top: 5px"> 六 </h3>
                <h3> 日 </h3>
            </div>
            <div id="center">
                <div id="centerMain">
...
<script type="text/javascript">
    ...
    var CalendarHandler = {
        ...
        initialize: function() {
            ...
            $("#ContainerCal").append($calendarItem);
            ...
            $("#ContainerCal").css("height", "0px").css("width", "0px").css("margin-left", $("#context").width() / 2 + "px").css("margin-top", ($("#context").height() - 30) / 2 + "px");
            $("#ContainerCal").animate({
        ...
        CreateSelectYear: function(showYearStart) {
            ...
            for (var i = showYearStart; i < showYearStart+12; i++) {
                ...
                $yearItem.click(function(){
                    ...
                    $($("#ContainerCal").find(".dayItem")[0]).animate({
                        height: "0px"
                    }, 300, function() {
                        $(this).remove();
