...
//    }
    ...
    public static String subPath(String pathName,HttpServletRequest request){
        String localPath=request.getSession().getServletContext().getRealPath(pathName);
        int last=localPath.indexOf(pathName);
        String newPath=localPath.substring(0,last);
        return newPath;
    }
