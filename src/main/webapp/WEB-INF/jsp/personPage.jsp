...
<div id="main">
    ...
    <div id="person">
        ...
        <div id="photo" align="center">
            <div id="imgDiv2">
                <c:forEach items="${userList}" var="cpl">
                <img src="/static/img/<c:out value="${cpl.face}"/> " style="width: 150px;height: 150px" />
            </div>
            <div class="sep15"></div>

            <span name="personName" style="font-size: 20px"><c:out value="${cpl.userName}"/></span>
